...
(echo n; echo p; echo 1; echo ; echo "$FS1_END_SECTOR"; echo t; echo b; echo w) | sudo fdisk $FDISK_ATTR /dev/loop0 > /dev/null 
FS1_END_SECTOR=`sudo fdisk -l -u=sectors /dev/loop0 | grep p1 | awk '{print $3}'`
FS2_START_SECTOR=$(( $FS1_END_SECTOR + 1 ));
echo "Partition 2 start sector: $FS2_START_SECTOR"
(echo n; echo p; echo 2; echo "$FS2_START_SECTOR"; echo ; echo t; echo 2; echo 83; echo w) | sudo fdisk $FDISK_ATTR /dev/loop0 > /dev/null 
echo "- stage 2/6" 
